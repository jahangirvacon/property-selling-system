        ...
        <div>
            ...
            <Row>
                ...
                <Row>
                        <Col span={8}>
                            <div className="site-card-border-less-wrapper">
                                <Card title=" Payment Details" bordered={false} style={{ width: 300 }}>
                                    <h1>No Payments</h1>
                                    <h1><EditOutlined /></h1>
                                </Card>
                            </div>
...
export default DirectBookingTesting;